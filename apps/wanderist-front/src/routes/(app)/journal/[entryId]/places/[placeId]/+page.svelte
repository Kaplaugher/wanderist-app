	...
	<div class="mt-5 flex lg:ml-4 lg:mt-0">
		<form method="POST">
			<button
				...
				class="inline-flex items-center rounded-md bg-red-400 px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-red-600"
			>
				<svg
